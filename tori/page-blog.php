    ...
    <div class="p-blog" id="top">
        ...
        <div class="p-blog__inner">
            <section class="main">
                ...
                $not_slug = 'info';
                $not_cat = get_category_by_slug($not_slug); 
                $not_catID = $not_cat->term_id;
                ...
                <a href="<?php the_permalink(); ?>" class="main-new">
                    ...
                    <div class="main-new__right">
                        ...
                        <div class="sp-row">
                            <p class="c-category"><span><?php echo get_the_category()[0]->name; ?></span></p>
                            <p class="c-blog__date"><?php echo custom_date(get_post_time('Y.m.d'),get_post_time('Y-m-d')); ?></p>
                        </div>
                ...
                <div class="main__list">
                    ...
                    <a href="<?php the_permalink(); ?>" class="main-item c-blog">
                        <p class="c-category ab">
                            ...
                            <?php
                                echo limit_content_chr(get_the_category()[0]->name, 23);
                            ?>
                            </span> 
                            <span class="pc-hidden">
                            <?php
                                echo limit_content_chr(get_the_category()[0]->name, 19);
                            ?>
                            </span>  
                        </p>
                        <img src="<?php echo feature_img(get_the_ID()); ?>" alt="" class="c-blog__img">
